...
<!--from-->
<div id="content">
<div id="page-heading"><h1>編輯新聞</h1></div>
<form action="news_edit_save.php" method="post"  name="formx" id="formx" onsubmit="return su();" >
<input type="hidden" id="nid" name="nid" value="<?=$news['news_id'];?>" />
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0">
			...
			<td>
				...
				<tr>
					...
					<td><input type="text" id="title" name="title" value="<?=$news['title'];?>" class="inp-form-error" /></td>
					<td>
				...
				<tr>
					...
					<td><textarea rows="" cols="" id"content" name="content" class="form-textarea"><?=$news['content'];?></textarea></td>
					<td></td>
				</tr>
				<tr>
					<th valign="top">排序:</th>
					<td><input type="text" id="inx" name="inx" value="<?=$news['inx'];?>" class="inp-form" /></td>
					<td>
					<div class="error-left"></div>
