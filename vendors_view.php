        ...
        <div class="maincontent">
        	<div class="contentinner">
                ...
                <div class="widgetcontent bordered shadowed nopadding">
                    ...
                    <input type="hidden" id="vid" name="vid" value="<?=$data['vendors_id'];?>" />
                            <p>
                                <label>廠商名稱</label>
                            ...
                            <p>
                                <label>E-mail</label>
                                <span class="field"><input type="text" name="mail" id="mail" value="<?=$data['email'];?>" class="input-xxlarge" /></span>
                            </p>                                                    
